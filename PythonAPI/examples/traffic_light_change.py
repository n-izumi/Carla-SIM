...
# sinage_event_addres = "https://api.github.com/some/endpoint"
# test_payload = {
#     "some": "data"
# }
# sinage_event_addres = "http://ja.wikipedia.org/w/api.php"
# test_payload = {
#     "format": "json",
#     "action": "query",
#     "prop": "revisions",
...
#     "rvparse": ""
# }
sinage_event_addres = "http://192.168.11.167:5001/"
# sinage_event_port = 5001
...
def sinage_event_send(payroad):
    ...
    # r = requests.get(sinage_event_addres, params="payroad")
    # print(r.encoding)
    # print(r.url)
    # print(r.text)
    # print(r.json())
...
def sinage_event_generate(lanes):
    ...
    for i, lane in enumerate(lanes):
        ...
        if i != len(lanes) - 1:
            value += ","
        # lane_value = {
        #     "LaneNo": str(lane["lane_no"]),
        #     "State": str(state),
        #     "ImegeNo": str(image_no),
        #     "TrafficInstruction": "2",
        #     "EmergencyStop": "0"
        # }
        # value.append(lane_value)
    value += "]"
...
def main():
    ...
    try:
        ...
        #         blueprint.set_attribute('role_name', 'autopilot')
            ...
            # for c in blueprint.get_attribute('color').recommended_values:
            #     print(c)
